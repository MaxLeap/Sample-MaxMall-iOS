...
@interface MLEBWebViewController () <WKNavigationDelegate>
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) UIActivityIndicatorView *activityIndicatorView;
@property (nonatomic, strong) UIProgressView *progressView;
@end

@implementation MLEBWebViewController
...
- (void)viewDidLoad {
    ...
    [self.webView loadRequest:[NSURLRequest requestWithURL:self.urlString.toURL]];
}
